...
for i in reviewl:
    while len(i) < 10:
        st.warning("The review is too short, please write a detailed review. Note: Make use of positive or negative words to correctly express yourself. e.g use (I feel bad) instead of (I don't feel good)")
    break        
